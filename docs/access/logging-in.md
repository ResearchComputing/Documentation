...
Research Computing offers a host of resources for users to utilize in their own research and projects. To get started with Research Computing resources we need: 

- [A Research Computing account]()
- [Duo 2 factor authentication]()
- [The PuTTY application](https://www.putty.org/) (if you are a Windows user)  

Users accessing RC's resources will be connected to a login node. A login node is a outward facing node within Research Computing's cluster environment that users can connect to with the ssh protocol. Once on a login node, users can:
...
For all other tasks, users should use batch jobs, interactive jobs, or the compile nodes 
...
Although Research Computing resources are free and available to the CU Boulder research community, it is also a managed resource with large value and high demand. It is because of this that Research Computing mandates that users obtain an individual Research Computing account. Please note that **Research Computing accounts are separate from your CU accounts. You must sign up for an individual Research Computing account if you wish to access Research Computing resources.**

A Research Computing account can be secured quickly and easily by [filling out the form here](). Once you've received an account with Research Computing, you will automatically be sent an invitation for Duo enrollment via email. After you have accepted the Duo invitation, you will be able to log into the system.
...
Much like with a Macs, Linux machines require no additional setup to access Research Computing resources. Simply utilize the your Linux distribution's terminal to access Research Computing resources. 
