...
| Time | Specifies the duration of the job. The maximum duration is dependent on the QoS or partition, and is 12 hours for `ahub` and 24 hours for most other partitions, unless the `long` QoS is specified. |
