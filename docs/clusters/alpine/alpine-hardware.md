...
| {{ alpine_ucb_total_h200_gpu_nodes }} Turin NVIDIA GPU    | ah200               | x86_64 AMD Turin | 2       | 128            | 1            |  {{ alpine_h200_ram_per_core }}           | NVIDIA H200 | 4         | 4T SSD                   | 100 Gb Ethernet                        |
| {{ alpine_ucb_total_rtxpro6000_gpu_nodes }} Turin NVIDIA GPU    | artxpro6000             | x86_64 AMD Turin | 2       | 128            | 1            |  {{ alpine_rtxpro6000_ram_per_core }}           | NVIDIA RTX Pro 6000 | 4         | 4T SSD                   | 100 Gb Ethernet                     |
...
| artxpro6000    | GPU-enabled (4x NVIDIA RTX Pro 6000)<sup>6</sup>. For select nodes, MIG has been enabled (see [Available GRES on Alpine](#available-gres-on-alpine)). | {{ alpine_total_artxpro6000_nodes }}          | 128         |   {{ alpine_rtxpro6000_ram_per_core }}        | 6.1<sup>3</sup>     |
...
| `rtx_pro_6000` | NVIDIA RTX Pro 6000 GPU with 96 GB of VRAM |  `artxpro6000` |  <ul><li>Total: 13</li><li>Max/user: 4</li></ul>   | <ul><li>Total: 5</li><li>Max/user: 2</li></ul> |  N/A | TODO |  162.9|
| `rtx_pro_6000_2g.48gb` | NVIDIA RTX Pro 6000 GPU with 48 GB of VRAM made possible by NVIDIA's [Multi-Instance GPU (MIG)](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/index.html) feature |  `artxpro6000` |  <ul><li>Total: 13</li><li>Max/user: 4</li></ul>   | <ul><li>Total: 5</li><li>Max/user: 2</li></ul> |  N/A | TODO |  81.45 |
| `rtx_pro_6000_1g.24gb` | NVIDIA RTX Pro 6000 GPU with 24 GB of VRAM made possible by NVIDIA's [Multi-Instance GPU (MIG)](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/index.html) feature |  `artxpro6000` |  <ul><li>Total: 29</li><li>Max/user: 7</li></ul>   | <ul><li>Total: 6</li><li>Max/user: 2</li></ul> |  N/A | TODO |  40.73 |
| `h200` | NVIDIA H200 GPU with 141 GB of VRAM |  `ah200` |  <ul><li>Total: 13</li><li>Max/user: 4</li></ul>   | <ul><li>Total: 5</li><li>Max/user: 2</li></ul> |  N/A | TODO |  217.2|
| `h200_3g.71gb` | NVIDIA H200 GPU with 71 GB of VRAM made possible by NVIDIA's [Multi-Instance GPU (MIG)](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/index.html) feature |  `ah200` |  <ul><li>Total: 13</li><li>Max/user: 4</li></ul>   | <ul><li>Total: 5</li><li>Max/user: 2</li></ul> |  N/A | TODO |  108.6|
| `h200_2g.35gb` | NVIDIA H200 GPU with 35 GB of VRAM made possible by NVIDIA's [Multi-Instance GPU (MIG)](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/index.html) feature |  `ah200` |  <ul><li>Total: 21</li><li>Max/user: 6</li></ul>   | <ul><li>Total: 5</li><li>Max/user: 2</li></ul> |  N/A | TODO |  72.4|
