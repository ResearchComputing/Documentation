...
| atesting | AMD Milan test nodes | Pulled from CU amilan pool | 32 or 48 or 64 |   3.75        | 0.025                   | see [atesting section](./alpine-hardware.md#atesting-usage-examples) below                 | see [atesting section](./alpine-hardware.md#atesting-usage-examples) below |
