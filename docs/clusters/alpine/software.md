...
| [Julia](https://julialang.org/) | 0.6.2, 1.6.0, 1.6.6, 1.8.1, 1.9.4, 1.10.2, 1.11.6 (D) | Julia is a high-level, dynamic programming language. Its features are well suited for numerical analysis and computational science. |
...
| [NVIDIA HPC SDK](https://developer.nvidia.com/hpc-sdk) (G)| 2022.229 (CUDA 11.7), 2023.233 (D, CUDA 12.0), 2025.251 (CUDA 12.6), 2025.255 (CUDA 12.9) | The NVIDIA HPC Software Development Kit (SDK) includes the proven compilers, libraries and software tools essential to maximizing developer productivity and the performance and portability of HPC applications. | 
