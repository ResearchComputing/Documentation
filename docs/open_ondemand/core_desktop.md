...
:alt: Core Desktop session showing a Linux desktop with terminal, file manager, and web browser windows.
:align: center
```
...
:alt: Running Core Desktop session with the Launch Core Desktop button circled.
:align: center
:scale: 50%
```
