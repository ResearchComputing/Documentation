...
* 2 classes of storage: active and archive
	...
	* See our `website <https://www.colorado.edu/rc/resources/petalibrary/storageandrates>`_ for pricing information
...
PetaLibrary access is subject to the `PetaLibrary Terms of Service <https://www.colorado.edu/rc/resources/petalibrary/tos>`_.

.. toctree::
    :maxdepth: 1
    :caption: PetaLibrary Intro
    :glob:
