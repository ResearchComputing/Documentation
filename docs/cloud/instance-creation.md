...
* If you are not a CU Boulder user (and therefore do not have VPN access), please follow the instructions provided here <https://curc.readthedocs.io/en/latest/access/rmacc.html#shell-access-to-summit-compute-nodes> for running a terminal through OpenOnDemand and then SSH from the provided terminal.
