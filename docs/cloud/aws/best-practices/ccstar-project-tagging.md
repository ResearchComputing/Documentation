## AWS - Project Tagging Requirement for ucboitrccumulus
...
NOTE: Note that the "tag **key**" is case sensitive.
This means that "**Project**" is valid (must contain capital 'P').
Using "project" (all lower case) as the key will generate an error, and this is the expected behavior.
